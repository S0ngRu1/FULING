            ...
            <div v-else class="flex flex-col flex-1 h-full bg-[#1F1F2C]">
                 <header class="p-4 border-b border-white/10 flex items-center justify-between shrink-0">
                    ...
                    <button
                      ...
                      class="h-10 px-4 py-2 rounded-lg bg-red-600 hover:bg-red-500 text-white flex items-center justify-center gap-2 transition-colors duration-200"
                      title="保存对话并退出"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                      </svg>
                      <span class="text-sm font-medium">保存对话并退出</span>
                    </button>
                </header>
